...
from execution.rebalance_core import OrderIntent
from broker.groww_client import DEFAULT_GROWW_UNIVERSE, GrowwInstrument, GrowwSession
...
def actual_weight_snapshot(
    ...
    return {
        ...
        "idle_cash_weight": float(available_cash) / total_equity,
